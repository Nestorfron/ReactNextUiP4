...
export const CreateUsersMB = () => {
  ...
  const handleFileUpload = () => {
    ...
    reader.onload = (e) => {
      ...
      const expectedColumns = ["user_name_MB", "is_active", "names", "last_names", "employee_number", "branch_id", "asset_id"];
      ...
      rows.forEach((row) => {
        const [user_name_MB, is_active, names, last_names, employee_number, branch_id, asset_id] = row;
        console.log(user_name_MB, is_active, names, last_names, employee_number, branch_id, asset_id);
        actions.add_userMB(
            user_name_MB,
            is_active,
            names,
