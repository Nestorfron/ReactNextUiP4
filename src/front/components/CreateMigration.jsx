...
export const CreateMigrations = () => {
  ...
  const handleFileUpload = () => {
    ...
    reader.onload = (e) => {
      ...
      const expectedColumns = ["Fecha de Instalación", "Fecha de Migración", "Descripción de Migración", "Estado de Migración", "ID de Usuario", "Proveedor", "Sucursal"];
      ...
      rows.forEach((row) => {
        const [installation_date, migration_date, migration_description, migration_status, user_id, provider_id, branch_id] = row;
        console.log(installation_date, migration_date, migration_description, migration_status, user_id, provider_id, branch_id);
